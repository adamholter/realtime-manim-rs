/* @ts-self-types="./realtime_manim_web_preview.d.ts" */
...
export class WebPlayer {
    static __wrap(ptr) {
        const obj = Object.create(WebPlayer.prototype);
        obj.__wbg_ptr = ptr;
        WebPlayerFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WebPlayerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_webplayer_free(ptr, 0);
    }
    clear_render_size() {
        const ret = wasm.webplayer_clear_render_size(this.__wbg_ptr);
        if (ret[1]) {
     ...
     */
    current_time() {
        const ret = wasm.webplayer_current_time(this.__wbg_ptr);
        if (ret[2]) {
    ...
    destroy() {
        const ret = wasm.webplayer_destroy(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    is_destroyed() {
        const ret = wasm.webplayer_is_destroyed(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
    ...
    load_scene(scene_json) {
        ...
        const ret = wasm.webplayer_load_scene(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    recovery_count() {
        const ret = wasm.webplayer_recovery_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {string} family
     ...
     */
    register_font(family, weight, slant, data) {
        const ptr0 = passStringToWasm0(family, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(weight, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(slant, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.webplayer_register_font(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    registered_font_count() {
        const ret = wasm.webplayer_registered_font_count(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
    ...
    reset_clock() {
        const ret = wasm.webplayer_reset_clock(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    resume() {
        const ret = wasm.webplayer_resume(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    seek(time) {
        const ret = wasm.webplayer_seek(this.__wbg_ptr, time);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    set_paused(paused) {
        const ret = wasm.webplayer_set_paused(this.__wbg_ptr, paused);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    set_render_size(width, height) {
        const ret = wasm.webplayer_set_render_size(this.__wbg_ptr, width, height);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    set_signal(signal, value) {
        const ptr0 = passStringToWasm0(signal, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webplayer_set_signal(this.__wbg_ptr, ptr0, len0, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    simulate_device_loss() {
        const ret = wasm.webplayer_simulate_device_loss(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
export function clear_render_size() {
    wasm.clear_render_size();
}

/**
 * Creates a renderer without using the legacy document-wide singleton.
 * @param {HTMLCanvasElement} canvas
 * @returns {Promise<WebPlayer>}
 */
export function create_player(canvas) {
    const ret = wasm.create_player(canvas);
    return ret;
}
 ...
 * @returns {number}
 */
export function current_scene_time() {
    const ret = wasm.current_scene_time();
    return ret;
}

export function destroy_engine() {
    const ret = wasm.destroy_engine();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {number}
 */
export function device_recovery_count() {
    const ret = wasm.device_recovery_count();
    return ret >>> 0;
}
 ...
 * @returns {string}
 */
export function evaluate_scene(scene_json, time) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(scene_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.evaluate_scene(ptr0, len0, time);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
export function initialize_canvas(canvas) {
    const ret = wasm.initialize_canvas(canvas);
    return ret;
}
 ...
 * @param {string} scene_json
 */
export function load_scene(scene_json) {
    const ptr0 = passStringToWasm0(scene_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @param {Uint8Array} data
 */
export function register_font(family, weight, slant, data) {
    const ptr0 = passStringToWasm0(family, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(weight, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const ptr3 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.register_font(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function reset_clock() {
    wasm.reset_clock();
}

export function resume_scene() {
    wasm.resume_scene();
}
 ...
 * @param {number} time
 */
export function seek_scene(time) {
    wasm.seek_scene(time);
}
 ...
 * @param {number} height
 */
export function set_render_size(width, height) {
    const ret = wasm.set_render_size(width, height);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {number} value
 */
export function set_signal(signal, value) {
    const ptr0 = passStringToWasm0(signal, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.set_signal(ptr0, len0, value);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

export function simulate_device_loss() {
    const ret = wasm.simulate_device_loss();
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @returns {string}
 */
export function validate_scene(scene_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(scene_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.validate_scene(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h066c7a444980506f(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_webplayer_new: function(arg0) {
            const ret = WebPlayer.__wrap(arg0);
            return ret;
        },
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5619b74b5c055fc4);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h0bb89213f9b6e4a2);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h0689613f8058226b);
            return ret;
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("GPUDeviceLostInfo")], shim_idx: 73, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h37ccba133a4bf180);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_4);
            return ret;
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_5);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./realtime_manim_web_preview_bg.js": import0,
    };
}

function wasm_bindgen__convert__closures_____invoke__h37ccba133a4bf180(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h37ccba133a4bf180(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h5619b74b5c055fc4(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h5619b74b5c055fc4(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h0689613f8058226b(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h0689613f8058226b(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_4(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_4(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_5(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h0689613f8058226b_5(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h066c7a444980506f(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h066c7a444980506f(arg0, arg1, arg2, arg3);
}

function wasm_bindgen__convert__closures_____invoke__h0bb89213f9b6e4a2(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h0bb89213f9b6e4a2(arg0, arg1, arg2);
}
...
const WebPlayerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_webplayer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('realtime_manim_web_preview_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
